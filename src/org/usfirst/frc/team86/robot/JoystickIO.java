...
public class JoystickIO {
	...
	private static  Joystick[] joysticks = {leftJoystick, rightJoystick, coJoystick};
	
	// Buttons
	private static ArrayList<Button> buttons = new ArrayList<>();
	
	public static Button getCube = createButton(coJoystick,1);
	public static Button releaseCube = createButton(coJoystick,4);
	
//	public static Button exchange = createButton(coJoystick, 2);
	public static Button switchHeight = createButton(coJoystick, 11);
	public static Button scaleLow = createButton(coJoystick, 9);
	public static Button scaleHigh = createButton(coJoystick, 7);
	
	public static Button jogArmUp = createButton(coJoystick, 10);
	public static Button jogArmDown = createButton(coJoystick, 12);
		
	public static Button gearShiftUp = createButton(rightJoystick, 5);
	public static Button gearShiftDown = createButton(rightJoystick, 1);
	...
	//public static Button xBox = createButton(leftJoystick,);
